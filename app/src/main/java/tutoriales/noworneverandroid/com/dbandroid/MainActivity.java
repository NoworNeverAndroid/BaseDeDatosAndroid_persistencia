package tutoriales.noworneverandroid.com.dbandroid;
...
import adaptadores.CartaCursoAdapter;
import db.DataBaseManagerCurso;
import model.Curso;
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case R.id.btnInsertar:
                ...
                for (int i=0; i<10; i++){
                    managerCurso.insertar_4parametros(null, "curso"+i, "descripcion "+i,""+i*2 );
                }
            ...
            case R.id.btnActalizar:
                for(int i=0; i< listaItemsCursos.size(); i++) {
                    managerCurso.actualizar_4parametros(listaItemsCursos.get(i).getId(), "cursillo:" + i, "descripcion Personalizada" + i, "" + i * 5);
                }
                break;
